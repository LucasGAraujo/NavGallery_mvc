...
namespace NavGallery.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(NavGalleryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marca != null ? 
                          ...
                          Problem("Entity set 'NavGalleryContext.Marca'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Id")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id")] Marca marca)
        {
            if (id != marca.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NavGalleryContext.Marca'  is null.");
            }
            var marca = await _context.Marca.FindAsync(id);
            if (marca != null)
            {
